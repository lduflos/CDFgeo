...
class Chaire(db.Model):
    ...
    chaire_debut = db.Column(db.Date)
    chaire_fin = db.Column(db.Date)
...
class Personne(db.Model):
    ...
    personne_naissance = db.Column(db.Date)
    personne_deces = db.Column(db.Date)
...
class Mission(db.Model):
    ...
    mission_date_debut = db.Column(db.Date)
    mission_date_fin = db.Column(db.Date)
